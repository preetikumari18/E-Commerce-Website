...
<form action="LoginController" method="post" style="width:400px;height:270px;border:1px solid #ccc">
...
New to Consonant? <a href ="Register.jsp">Click here to create an account</a>
</form>
<div id="footer">
